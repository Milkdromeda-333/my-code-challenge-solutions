...
// IDEA: create an empty array, do a loop through an array that is populated with both strings turned ino arrays, each iteration loop through the comboArr and if you find the current letter, skip to the next iteration. return the array joined. 
	const arr = [...s1, ...s2];
	const comboArr = []
	for(letter of arr){
